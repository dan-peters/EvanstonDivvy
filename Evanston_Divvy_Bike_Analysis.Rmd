...
A future analysis should consider the question of why certain trip paths are traveled more frequency. This might be partially explained by ease of travel, such as bike lanes, and it would be interesting to compare the locations of bike lanes with popular Divvy routes.
